...
with tab_analysis:
    if s_data is not None:
        ...
        # HRR 분석: 본훈련 종료 후 쿨다운 기간의 심박 낙차 시각화
        fig_hrr = go.Figure()
...
# --- [TAB 3: PROGRESSION (그래프 대폭 추가)] ---
with tab_trends:
    if not df.empty:
        # 1. W/kg 성장 곡선 (Target 180W @ 85kg)
